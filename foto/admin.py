...
from foto.models import Album, AlbumImage
from foto.forms import AlbumForm
        ...
        if form.is_valid():
            ...
            if form.cleaned_data['zip'] != None:
                ...
                for filename in sorted(zip.namelist()):
                    ...
                    filepath = '{0}/albums/{1}'.format(fotonov.settings.MEDIA_ROOT, filename)
...
# В случае, если изображение должно быть удалено из альбома.
